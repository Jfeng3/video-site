  ...
  render() {
    return (
      <li className="product-item">
        ...
        //<video className="product-item-media" src={this.props.media} />
        <video height="720" width="1080" preload="auto" className="product-item-media" data-video-width="1080" data-video-height="720" src={this.props.media} />
